...
// ─── Run Status Display ───────────────────────────────────────────────────────
export function renderRunStatus(state) {
    const statusColor = {
        running: chalk.green,
        paused: chalk.yellow,
        done: chalk.cyan,
    ...
    const elapsed = Math.round((Date.now() - new Date(state.createdAt).getTime()) / 1000);
...
// ─── Validation Results ───────────────────────────────────────────────────────
export function renderValidatorResult(result) {
