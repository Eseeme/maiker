...
export async function runDeterministicValidators(opts) {
    ...
    for (const validator of validators) {
        if (!isDeterministicValidator(validator))
            continue;
...
async function runSingleValidator(validator, cwd, pm, onOutput) {
...
function isDeterministicValidator(v) {
    return [
        'install',
        'build',
        'lint',
